...
player_tmp_cmps = e_cmp_render | e_cmp_movable | e_cmp_input | e_cmp_collider
...
player_tmp:
    ...
    DefineEntity player1, e_type_player  player_tmp_cmps  #0x27, #0x28, #0x00, #0x00, #0x08, #0x1D, #_spr_mago_0,  #0x0000,              player_tmp_collider 
enemy_tmp:
    DefineEntity enemy1, e_type_enemy    enemy_tmp_cmps   #0x39, #0x20, #0x00, #0x00, #0x08, #0x14, #_spr_enemy, #ia_seguimiento_player, enemy_tmp_collider