...
shot_tmp_collider = e_type_enemy   ;; la bala colisiona con los enemigos
...
player_tmp:
    ...
    DefineEntity player1, e_type_player  player_tmp_cmps  #0x27, #0x28, #0x00, #0x00, #0x05, #0d20, #_spr_player1_00,  #0x0000,  #player1_stop_down, #0x0C,  player_tmp_collider,      0x00 
enemy_tmp:
    DefineEntity enemy1, e_type_enemy    enemy_tmp_cmps   #0x39, #0x20, #0x00, #0x00, #0x08, #0x14, #_spr_enemy, #ia_seguimiento_player, #0x0000,    #0x00,  enemy_tmp_collider,       0x00
